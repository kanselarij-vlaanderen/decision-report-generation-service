...
export function renderReport(
  ...
  // return `
  //   <div class="au-u-margin-bottom-large au-u-flex au-u-flex--column">
  //     <div class="auk-o-flex auk-o-flex--horizontal-center l-logo-header">
  //       <svg
  ...
  //       </svg>
  //     </div>
  //     <p class="au-u-text-center au-u-flex-self-center">
  //       Vergadering van ${weekdayName(plannedStart)} ${plannedStart}
  //     </p>
  //     <hr
  //       class="au-u-margin-top au-u-flex-self-center l-decision-viewer__header-underline"
  //     />
  //   </div>
  //   <h5 class="auk-u-text-decoration-underline">
  //     ${numberRepresentation} - punt ${addLeadingZeros(agendaItemNumber, 4)}
  //   </h5>
  //   <h5 class="auk-u-text-decoration-underline au-u-padding-top">Betreft:</h5>
  //   ${reportParts.concerns}
  //   <h5 class="auk-u-text-decoration-underline au-u-padding-top">
  //     Beslissing:
  //   </h5>
  ...
  <div>
    <div class="au-u-margin-bottom-large au-u-flex au-u-flex--column">
      ...
      <p style="text-align: center; margin: 0 auto;" class="au-u-text-center au-u-flex-self-center">
        Vergadering van ${formatDate(plannedStart)}      </p>
      <hr
        class="au-u-margin-top au-u-flex-self-center l-decision-viewer__header-underline"
      />
      </div>
    </div>
    <h5 style="text-decoration: underline;" class="auk-u-text-decoration-underline">
      ${numberRepresentation} - punt ${addLeadingZeros(agendaItemNumber, 4)}
    </h5>
    <h5 style="text-decoration: underline;" class="auk-u-text-decoration-underline au-u-padding-top">Betreft:</h5>
    ${reportParts.concerns}
    <h5 style="text-decoration: underline;" class="auk-u-text-decoration-underline au-u-padding-top">
      Beslissing:
    </h5>
    ${reportParts.decision}
    </div>
